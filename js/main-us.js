/* ============================================================
   DETAILING (US) — interactions & animations
   ============================================================ */
(function () {
  'use strict';
  ...
  function animateCount(el, target, dec, plus) {
    ...
    function tick(now) {
      ...
      el.textContent = (dec ? val.toFixed(dec) : Math.round(val).toLocaleString('en-US')) + (plus && p === 1 ? plus : '');
      if (p < 1) requestAnimationFrame(tick);
      else el.textContent = (dec ? target.toFixed(dec) : Math.round(target).toLocaleString('en-US')) + (plus || '');
    }
  ...
  function recalc() {
    ...
    if (items.length === 0) {
      listEl.innerHTML = '<li class="calc__empty">Pick services on the left</li>';
    } else {
  ...
  const SERVICES = {
    polish: {
      tag: 'Paint Correction', price: 'from $299', img: 'assets/img/car-gloss.jpg', title: 'Paint Correction',
      lead: 'Multi-stage machine polishing that cuts out swirls, scratches, and holograms — bringing back deep color and a wet, mirror-like shine.',
      list: [
        '<b>What it is:</b> we remove a micro-layer of clear coat with graduated compounds, then refine to a flawless finish.',
        '<b>Why you need it:</b> kills spider-webbing, wash marring, and dullness — the color pops again.',
        '<b>The result:</b> a swirl-free, glass-smooth finish. Your ride looks worth way more.',
        '<b>Pro tip:</b> pair it with a ceramic coating — correction preps the paint, ceramic locks it in.'
      ]
    },
    ceramic: {
      tag: 'Ceramic Coating', price: 'from $899', img: 'assets/img/detail3.jpg', title: 'Ceramic Coating',
      lead: 'A liquid-glass nano-ceramic layer that bonds to your clear coat, repels water and grime, and keeps that deep gloss for years.',
      list: [
        '<b>What it is:</b> a silica-based (SiO₂) coating that cures directly onto the paint.',
        '<b>Why you need it:</b> guards against UV fade, road salt, chemicals, and light scratches — and makes washing a breeze.',
        '<b>The effect:</b> serious hydrophobics — water beads and rolls right off, dirt won\'t stick.',
        '<b>How long it lasts:</b> up to 5 years depending on the package and number of layers.'
      ]
    },
    wrap: {
      tag: 'Vinyl Wraps & PPF', price: 'from $2,499', img: 'assets/img/detail4.jpg', title: 'Vinyl Wraps & PPF',
      lead: 'Premium color-change vinyl and paint protection film. Switch up the look — gloss, matte, satin, or color-shift — while shielding your paint.',
      list: [
        '<b>What it is:</b> color-change vinyl or clear paint protection film (PPF) applied over your factory paint.',
        '<b>Why you need it:</b> protects the original paint from rock chips and scratches, and holds resale value.',
        '<b>Your options:</b> full color change or just the high-impact zones — hood, bumper, mirrors, headlights.',
        '<b>Warranty:</b> up to 7 years on the film, and it peels off clean with no damage to your paint.'
      ]
    },
    cleaning: {
      tag: 'Interior Detailing', price: 'from $189', img: 'assets/img/interior2.jpg', title: 'Interior Detailing',
      lead: 'A deep clean for every surface — leather, alcantara, fabric, plastics, and headliner — plus an ozone treatment to kill odors.',
      list: [
        '<b>What it is:</b> wet and dry cleaning with pro-grade products and hot-water extraction.',
        '<b>Why you need it:</b> lifts stains, dust, allergens, and funky smells — the cabin feels new again.',
        '<b>Leather care:</b> gentle cleaning plus conditioning to protect against drying and cracking.',
        '<b>The result:</b> looks and smells factory-fresh — safe on every material.'
      ]
    },
    headlight: {
      tag: 'Headlight Restoration', price: 'from $99', img: 'assets/img/headlight2.jpg', title: 'Headlight Restoration',
      lead: 'We clear up the haze and yellowing, restore crystal-clear lenses, and bring your beams back to full brightness.',
      list: [
        '<b>What it is:</b> stage-by-stage wet sanding and polishing of the lens, sealed with a protective UV coat.',
        '<b>Why you need it:</b> foggy headlights throw less light and cheapen the whole car — it\'s a safety thing too.',
        '<b>The effect:</b> clear lenses and brighter, better-aimed light at night.',
        '<b>Protection:</b> a UV sealant slows the haze from coming back.'
      ]
    },
    prep: {
      tag: 'Show & Sale Prep', price: 'from $249', img: 'assets/img/detail5.jpg', title: 'Show & Sale Prep',
      lead: 'A full turnkey package before you sell or show: touchless wash, interior detail, paint correction, and protection. Sells faster, for more.',
      list: [
        '<b>What\'s included:</b> wash, interior clean, paint correction, plus trim and tire dressing.',
        '<b>Why you need it:</b> a spotless car makes a killer first impression and bumps the price.',
        '<b>The result:</b> fresh looks, clean smell, and real shine — buyers pay more.',
        '<b>Timeline:</b> usually one day depending on condition.'
      ]
    }
  };
  ...
  /* ============================================================
     HERO ROTATING PHRASE (optional; static headline by default)
     ============================================================ */
  ...
  /* ============================================================
     SCROLL PARALLAX (orbs + hero headlights)
     ============================================================ */
  const heroMedia = $('.hero__media');
  const heroLit = $('#heroImg');
